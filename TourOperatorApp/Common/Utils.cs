...
public class Utils
{
    ...
    public static List<Models.Route> routesList = new List<Models.Route>() {
                ...
                new Models.Route(2,"Батурин", "Тростянец", "Качановка", 143, "A+", instructorsList[2]),
                new Models.Route(3,"Винница", "Тульчин", "Буша", 90, "B-", instructorsList[3]),
                new Models.Route(4,"Урыч", "Розгирче", "Бубнище", 100, "B", instructorsList[4]),
                new Models.Route(5,"Каменец-Подольский", "Кривче", "Хотин", 55, "B+", instructorsList[0]),
